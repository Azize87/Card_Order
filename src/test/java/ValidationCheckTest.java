...
public class ValidationCheckTest {
   ...
   @Test
    ...
    @Test
    void shouldSendWithSymbolsInsteadOfName() {
        driver.get("http://localhost:9999/");
    ...
    @Test
    void shouldSendWithNameInLatin() {
        driver.get("http://localhost:9999/");
        driver.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Petrova Maria");
        driver.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+79054875965");
        driver.findElement(By.cssSelector("[data-test-id='agreement']")).click();
        driver.findElement(By.cssSelector("button")).click();
        String text = driver.findElement(By.cssSelector("[data-test-id='name'].input_invalid .input__sub")).getText().trim();
    ...
    @Test
    void shouldSendWithPhoneWithoutPlus() {
        driver.get("http://localhost:9999/");
        driver.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Петрова Мария");
        driver.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("79054875965");
        driver.findElement(By.cssSelector("[data-test-id='agreement']")).click();
    ...
    @Test
    void shouldSendWithPhoneWithoutCheckbox() {
        driver.get("http://localhost:9999/");
        driver.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Петрова Мария");
        driver.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+79054875965");
        driver.findElement(By.cssSelector("button")).click();
